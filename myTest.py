...
def test_read_cfg_from_file():
    ...
    ans_cfg = {'consumer_key' :'YZ0djZAoGRUVQx8heiaOr5nNG'}
...
def test_get_authenticated():
    ...
    tweepy.OAuthHandler.assert_called_once_with("YZ0djZAoGRUVQx8heiaOr5nNG","wrltfnZbABhZss1nlsppIBvAOm4CSim4IkbaFFRmFgVpIgQaky");

    auth = tweepy.OAuthHandler()
    auth.set_access_token.assert_called_once_with('838107760721985536-L2rzrPWAfN5PI1gITEF8NifSSeK0QjE', 'Zopx5zi0o3tKV0GviXdx4Nsb7aJJkDN7XvRvFc7DD3KMK')
